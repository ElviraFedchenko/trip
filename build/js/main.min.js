...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _vendor.initHeroSwiper)();
  (0, _vendor.initToursSwiper)();
  (0, _vendor.initTrainerSwiper)();
  (0, _vendor.initReviewSwiper)();
  (0, _vendor.initAdvantagesSwiper)();
  (0, _vendor.initGallerySwiper)();
...
var button = document.querySelector('.media__button');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setupVideo() {
    var link = video.querySelector('.media__link');
    var button = video.querySelector('.media__button');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setupAudio() {
    var button = audio.querySelector('.audio__button-play');
...
var menuList = header.querySelector('.main-nav__inner');
var menuToggle = header.querySelector('.main-nav__toggle');
...
var map = L.map('map', {
  ...
  dragging: false
}).setView([55.813152, 37.633832], 13);
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor.js":15,"./vendor/leaflet":17}],2:[function(require,module,exports){
"use strict";
...
exports.initTrainerSwiper = exports.initToursSwiper = exports.initReviewSwiper = exports.initHeroSwiper = exports.initGallerySwiper = exports.initAdvantagesSwiper = void 0;
require("./vendor/swiper");
require("./vendor/focus-visible-polyfill");
// Swiper 7.4.1

var heroSwiper = document.querySelector('.hero__slider');
var toursSwiper = document.querySelector('.tours__slider');
var trainerSwiper = document.querySelector('.training__slider');
var reviewSwiper = document.querySelector('.review__slider');
var advantagesSwiper = document.querySelector('.advantages__slider');
var gallerySwiper = document.querySelector('.gallery__slider');
...
var initTrainerSwiper = function initTrainerSwiper() {
  if (trainerSwiper) {
...
exports.initTrainerSwiper = initTrainerSwiper;
...
},{"./vendor/focus-visible-polyfill":16,"./vendor/swiper":18}],16:[function(require,module,exports){
"use strict";
